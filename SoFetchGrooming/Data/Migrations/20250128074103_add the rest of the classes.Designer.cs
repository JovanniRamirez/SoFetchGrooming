...
namespace SoFetchGrooming.Data.Migrations
{
    ...
    [Migration("20250128074103_add the rest of the classes")]
    partial class addtherestoftheclasses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoFetchGrooming.Models.PetList", b =>
                {
                    b.Property<int>("PetListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PetListId"));
            ...
            modelBuilder.Entity("SoFetchGrooming.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoFetchGrooming.Models.Appointment", b =>
                {
                    b.HasOne("SoFetchGrooming.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SoFetchGrooming.Models.Pet", b =>
                {
                    b.HasOne("SoFetchGrooming.Models.PetList", null)
                        .WithMany("Pets")
                        .HasForeignKey("PetListId");
